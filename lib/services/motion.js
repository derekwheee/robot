...
const { SLICES } = require('./helpers/state');
...
module.exports = class MotionService extends Schmervice.Service {
    ...
    init() {
        ...
        this.state.events.on(SLICES.RECEIVER_VALUES, this.enableSwitchListener.bind(this));
    ...
    enableSwitchListener(received) {
        ...
        const isEnabled = this.state.select(SLICES.MOTION_IS_ENABLED);
