...
const { COMM_TOPICS } = require('../utils/constants');
...
module.exports = class VisionService extends Schmervice.Service {
    ...
    async publishFrame() {
        ...
        const { communicationService } = this.server.services();

        communicationService.register(COMM_TOPICS.VISION, 'frame');
        ...
        await communicationService.publish(`${COMM_TOPICS.VISION}/frame`, { image, timestamp });
